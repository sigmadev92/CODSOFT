...
export default function WhoWeare() {
  ...
  return (
    <div className=" ">
      ...
      <div id="info" className="w-[80%] md:w-[50%] mx-auto mb-[50px]">
        <p className="">
      ...
      <div className="w-[70%] m-auto">
        <div id="team">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <img src={imgTeam} alt="team" className="w-[25%]" />
            <img src={imgTeam2} alt="team" className="w-[25%]" />
            <img src={imgTeam3} alt="team" className="w-[25%]" />
          </div>
        </div>
        <div id="developers">
          <h1 className="text-center font-bold mt-[20px]">
            Our Developers from World's Top Universities
          </h1>
